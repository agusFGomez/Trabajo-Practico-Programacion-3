...
Bajadecuentas::Bajadecuentas(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	Connect(ID_BUTTON1,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&Bajadecuentas::OnButton1Clicked);
	//*)
}
...
void Bajadecuentas::OnButton1Clicked(wxCommandEvent& event){
